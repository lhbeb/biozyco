# 📚 Biozy Codebase Understanding - Index

**Your Complete Guide to Understanding the Biozy Link-in-Bio Platform**
...
**Biozy** is a modern, full-stack **link-in-bio application** (similar to Linktree) that allows users to create beautiful, personalized landing pages with unlimited links. Built with Next.js 14, TypeScript, Tailwind CSS, and Supabase.
...
### Start Development
```bash
cd /Users/elma777boubi/Downloads/biozy-main
npm run dev
...
### Basic Understanding ✅
- [ ] I know what Biozy is and what it does
...
You now have **complete documentation** for the Biozy codebase:
