# 🚀 Biozy Quick Start Guide

Get your Biozy application up and running in minutes!
...
```bash
cd "/Users/elma777boubi/Downloads/Biozy.co"
npm install
```
...
1. **Create a Supabase Project**
   ...
   - Name it "Biozy" and wait for it to initialize
...
Your page will be live at `biozy.co/username`!
...
Your Biozy application is now running with:
