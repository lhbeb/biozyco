...
export function logDatabaseHealth(health: DatabaseHealth) {
  ...
  console.log('%c🔍 Biozy Database Health Check', 'font-size: 16px; font-weight: bold; color: #17803d;');
  console.log('%c━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━', 'color: #17803d;');
  
  // Connection Status
  if (health.connected) {
    console.log('%c✅ Connection: SUCCESS', 'color: #17803d; font-weight: bold;');
  } else {
  ...
  if (allHealthy) {
    console.log('%c🎉 All systems operational!', 'font-size: 14px; font-weight: bold; color: #17803d;');
  } else {
