        ...
        <div className="bg-white rounded-2xl shadow-sm p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none text-text-primary/80 space-y-6">
            ...
            <section>
              ...
              <p>
                Welcome to Biozy.co ("we," "our," or "us"). We are committed to protecting your privacy and ensuring you have a positive experience on our website and in using our services. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website biozy.co.
              </p>
            </section>
